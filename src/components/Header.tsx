...
const Header: React.FC<HeaderProps> = ({ darkMode, setDarkMode }) => {
  ...
  const [isAuthModalOpen, setIsAuthModalOpen] = useState(false); // Для модального окна
      ...
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6">
          ...
          <button
            ...
            className="hidden md:block px-4 py-2 border border-blue-600 text-blue-600 rounded-md hover:bg-blue-50 dark:border-blue-500 dark:text-blue-400 dark:hover:bg-gray-700 transition-colors"
          >
            Войти
          </button>
          {/* Переключатель темы */}
